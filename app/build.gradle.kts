...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        applicationId = "com.dom19.easytube"
        resValue("string", "app_name", "EasyTube")
        minSdk = 21
        targetSdk = 35

        versionCode = System.getProperty("versionCodeOverride")?.toInt() ?: 10000
    ...
    buildTypes {
        debug {
            ...
            if (normalizedWorkingBranch.isEmpty() || workingBranch in defaultBranches) {
                ...
                resValue("string", "app_name", "EasyTube Debug")
            } else {
                applicationIdSuffix = ".debug.$normalizedWorkingBranch"
                resValue("string", "app_name", "EasyTube $workingBranch")
            }
        }
        ...
        release {
            System.getProperty("packageSuffix")?.let { suffix ->
                ...
                resValue("string", "app_name", "EasyTube $suffix")
            }
            if (keystorePropertiesFile.exists()) {
